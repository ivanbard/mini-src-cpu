...
module cpu_tb;
    ...
    initial begin
        ...
        begin : check
            ...
            if (DUT.dp.key_regs_inst.HI.d_out !== 32'h00000004) begin $display("  FAIL HI"); pass=0; end
            if (DUT.dp.key_regs_inst.LO.d_out !== 32'h00000003) begin $display("  FAIL LO"); pass=0; end
