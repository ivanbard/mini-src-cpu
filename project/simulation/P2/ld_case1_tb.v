//  ld R7, 0x65  |  Rb=R0, EA=0x65  |  mem[0x65]=0x84  |  expect R7=0x84
`timescale 1ns/10ps
...
module ld_case1_tb;
    ...
    parameter Default=5'd0, T0=5'd1, T1=5'd2, T2=5'd3, T3=5'd4, T4=5'd5,
              T5=5'd6, T6=5'd7, T7=5'd8, Done=5'd9;
    ...
    initial begin
        $dumpfile("ld_case1_tb.vcd"); $dumpvars(0,ld_case1_tb);
        DUT.ram_inst.mem[9'h000]=32'h03800065;
        DUT.ram_inst.mem[9'h065]=32'h00000084;
        reset=1; #25; reset=0;
        wait(Present_state==Done); #40;
        $display("============================================");
        $display("LD Case 1: ld R7, 0x65");
        $display("  MAR = 0x%08h  (exp 0x00000065)", mar_val);
        $display("  R7  = 0x%08h  (exp 0x00000084)", DUT.rf.r7_out);
        if(DUT.rf.r7_out===32'h00000084) $display("  >>> PASSED <<<");
        else $display("  >>> FAILED <<<");
        $display("============================================");
        #20; $finish;
    end
