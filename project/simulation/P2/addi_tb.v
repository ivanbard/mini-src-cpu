...
module addi_tb;
    ...
    always @(Present_state) begin
        ...
        case(Present_state)
            ...
            RL4: begin c_val<=32'h00000020; bus_sel<=SEL_C; Gra<=1; Rin<=1; end
    ...
    initial begin
        $dumpfile("addi_tb.vcd"); $dumpvars(0,addi_tb);
        DUT.ram_inst.mem[9'h1FF] = 32'h02000000;
        DUT.ram_inst.mem[9'h000] = 32'h2BA7FFF7;
        reset=1; #25; reset=0;
        wait(Present_state==Done); #40;
        $display("============================================");
        $display("ADDI: addi R7, R4, -9");
