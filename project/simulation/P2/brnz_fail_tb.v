//  brnz R3, 48 (not-taken demo) — branch if R3 != 0
`timescale 1ns/10ps
...
module brnz_fail_tb;
    ...
    initial begin
        $dumpfile("brnz_fail_tb.vcd"); $dumpvars(0,brnz_fail_tb);
        DUT.ram_inst.mem[9'h1FF]=32'h01800000; // dummy Ra=R3
        DUT.ram_inst.mem[9'h000]=32'h41880030;
        r3_val = 32'h00000000;
        reset=1; #25; reset=0;
        wait(Present_state==Done); #40;
        $display("============================================");
        $display("BRNZ FAIL TB (not-taken demo): brnz R3, 48");
        $display("  [IR[20:19]=01]");
