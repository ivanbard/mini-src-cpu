...
//  brzr R3,48 (not-taken demo) [IR[20:19]=00 branch if R3==0]
`timescale 1ns/10ps
...
module brzr_fail_tb;
    ...
    initial begin
        $dumpfile("brzr_fail_tb.vcd"); 
        $dumpvars(0, brzr_fail_tb);
        DUT.ram_inst.mem[9'h1FF] = 32'h01800000; 
        DUT.ram_inst.mem[9'h000] = 32'h41800030; 
        r3_init = 32'h00000005;
        reset = 1; #25; reset = 0;
        wait(Present_state == Done); #40;
        $display("============================================");
        $display("BRZR FAIL TB (not-taken demo): brzr R3, 48");
