// st 0x1F, R6  |  R6=0x63, EA=0x1F  |  mem[0x1F] should become 0x63
`timescale 1ns/10ps
...
module st_case1_tb;
    ...
    initial begin
        $dumpfile("st_case1_tb.vcd"); $dumpvars(0,st_case1_tb);
        DUT.ram_inst.mem[9'h1FF]=32'h03000000;
        DUT.ram_inst.mem[9'h000]=32'h1300001F;
        DUT.ram_inst.mem[9'h01F]=32'h000000D4;
        reset=1; #25; reset=0;
        wait(Present_state==Done); #40;
        $display("============================================");
        $display("ST Case 1: st 0x1F, R6  [R6=0x63, mem[0x1F] was 0xD4]");
        $display("  R6       = 0x%08h  (exp 0x00000063)", DUT.rf.r6_out);
        $display("  MAR      = 0x%08h  (exp 0x0000001F)", mar_val);
        $display("  mem[0x1F]= 0x%08h  (exp 0x00000063)", DUT.ram_inst.mem[9'h01F]);
        if(DUT.ram_inst.mem[9'h01F]===32'h00000063) $display("  >>> PASSED <<<");
        else $display("  >>> FAILED <<<");
        $display("============================================");
        #20; $finish;
    end
