// ldi R7, 0x65  |  Rb=R0, EA=0x65  |  expect R7=0x65
`timescale 1ns/10ps
module ldi_case3_tb;
    reg clk, reset;
    reg [4:0] bus_sel;
    ...
    parameter Default=5'd0, T0=5'd1, T1=5'd2, T2=5'd3,
              T3=5'd4, T4=5'd5, T5=5'd6, Done=5'd7;
    ...
    initial begin
        $dumpfile("ldi_case3_tb.vcd"); $dumpvars(0,ldi_case3_tb);
        DUT.ram_inst.mem[9'h000]=32'h0B800065;
        reset=1; #25; reset=0;
        wait(Present_state==Done); #40;
        $display("============================================");
        $display("LDI Case 3: ldi R7, 0x65");
        $display("  R7  = 0x%08h  (exp 0x00000065)", DUT.rf.r7_out);
        if(DUT.rf.r7_out===32'h00000065) $display("  >>> PASSED <<<");
        else $display("  >>> FAILED <<<");
        $display("============================================");
        #20; $finish;
    end
